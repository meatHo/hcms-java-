...
class Car{
    ...
    void setposition(Car car,final Time time){
...
//여ㅛ기 수정 돈계산 하는데 ------------------------------------------------------------------------------------------------------
                for(int i=0;i<howcar;i++){
                    if(car[i].getonhighway()==1 && comptime(time,car[i].getarrivaltTime())==0){//도착한 차량
                        ...
                        //car[i].setmoney((basemoney+car[i].getdistance()*howdistance)*car[i].getspeed()/100*car[i].getbaegi()/2000);
